...
class Inventario(SerializableMixin):
    ...
    def cerca_oggetto(self, oggetto: Oggetto)->str:
        pass

    def mostra_inventario(self)-> tuple[list[Oggetto], str]:
        """
        con una tupla invia una copia del
    ...
    def usa_oggetto(self, oggetto : Oggetto, bersaglio= None, ambiente: Ambiente = None)->tuple[str, int]:
        pass

    def riversa_inventario(self):
        pass
    ...
    #                 msg = oggetto.usa(utilizzatore, bersaglio, mod_ambiente=mod_ambiente)
    #                 self.oggetti.remove(oggetto)
    #                 return
    #         msg = f"{utilizzatore.nome} non ha {oggetto.nome}."
    #         Log.scrivi_log(msg)
    #     else:
    #         msg = "Per usare un oggetto, l'inventario deve avere un proprietario"
